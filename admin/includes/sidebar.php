<nav class="admin__nav">
    ...
    <ul>
        <li class="admin__nav--item active">
            <a href="../index.php"><em class="fa-solid fa-house-user"></em></a>
        </li>

        <li class="admin__nav--item">
            <a href="index.php"><em class="fa-solid fa-dashboard"></em></a>
        </li>
        ...
        <li class="admin__nav--item">
            <a href="all_articles.php"><em class="fa-solid fa-newspaper"></em></a>
        </li>
    </ul>
</nav>